    ...
    <>
      ...
      <section className="stats">
        <div className="container">
          ...
          <ScrollReveal className="sr-stagger" delay={200}>
      ...
      <section className="paths">
        <div className="container">
          ...
          <ScrollReveal className="sr-stagger" delay={150}>
            <div className="paths-grid">
              <Link href="/ebook" className="path-card">
                <div className="path-tag">01 · Primary</div>
                <div className="path-icon">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                    <path d="M4 4H20V20H4V4Z" stroke="currentColor" strokeWidth="1.8" />
                ...
                <p>
                  ...
                  ROI before you sign a loan. $29 for launch, with instant delivery
                  when it ships.
                </p>
              ...
              <Link href="/shop" className="path-card">
                ...
                <div className="path-icon">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                    <path d="M6 4L4 7V20H20V7L18 4H6Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
                    <path d="M9 10C9 11.6569 10.3431 13 12 13C13.6569 13 15 11.6569 15 10" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                </div>
                <h3>Shop the Merch</h3>
                <p>
                  Assets over Liabilities. Options over Obligations. Wear the
                  philosophy. Printed on-demand, every piece ships direct.
                </p>
                <span className="path-link">
                  View the drop{" "}
                  <svg className="arrow" width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <Link href="/session" className="path-card">
                ...
                <div className="path-icon">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M14 20V18C14 15.7909 11.3137 14 8 14C4.68629 14 2 15.7909 2 18V20" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                    <path d="M16 11L18 13L22 9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <h3>Book a 1:1 Session</h3>
                <p>
                  Skip the DMs. Book a 45-minute strategy call to walk through
                  your actual numbers and leave with a ranked decision matrix.
                </p>
                <span className="path-link">
                  See availability{" "}
                  <svg className="arrow" width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <section className="manifesto">
        <div className="container">
          <ScrollReveal className="sr-scale">
      ...
      {/* ============ QUICK SIGNUP ============ */}
      <section className="quick-signup">
        <div className="container">
          <ScrollReveal>
            <div className="quick-signup-inner">
              <div className="quick-signup-content">
                <div className="eyebrow" style={{ color: "var(--green)" }}>
                  Stay in the loop
                </div>
                <h2>
                  Not ready to buy?
                  <br />
                  <span className="italic">Get on the list.</span>
                </h2>
                <p>
                  Free chapter, early merch drops, webinar invites, and first
                  access when the e-book goes live. No spam, unsubscribe any time.
                </p>
              </div>
              <div className="quick-signup-form-wrap">
                <QuickSignup />
              </div>
            </div>
          </ScrollReveal>
